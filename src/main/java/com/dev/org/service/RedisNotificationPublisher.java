...
public class RedisNotificationPublisher implements NotificationPublisher {
    ...
    private final ReactiveRedisTemplate<String, NotificationEvent> reactiveNotificationRedisTemplate;
    ...
    public Mono<Notification> publish(Notification notification) {
        ...
        return reactiveNotificationRedisTemplate.convertAndSend(
                        notificationChannelTopic.getTopic(), notificationEvent)
